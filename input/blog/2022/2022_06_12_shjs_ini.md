...
Looking at the language files included in [my SHJS 'distribution'](https://codeberg.org/xythobuz/website/src/branch/master/static/js/sh) I didn't find an obvious file for 'ini'.
